...
class ContactSection extends StatelessWidget {
  ...
  Future<void> _showDeleteDialog(String type, String value) async {
    ...
    if (result == true) {
      await controller.deleteManualCardContact(type);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (controller.manualCardcontacts.isEmpty) return const SizedBox();
      ...
      return Column(
        ...
        children: [
          ...
          ...controller.manualCardcontacts.entries.map((entry) {
